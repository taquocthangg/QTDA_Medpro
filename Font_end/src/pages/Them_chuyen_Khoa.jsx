...
const ThemChuyeKhoa = () => {
  ...
  const Delete_chuyen_khoa = async (idUser) => {
    try {
      ...
      const response = await axios.delete(`https://medprov2.onrender.com//api/v1/auth/xoaChuyenKhoa/` + idUser);
  ...
  const fetchDataChuyenKhoa = async () => {
     const response = await axios.get('https://medprov2.onrender.com//api/v1/auth/chuyenkhoa/' + getId)
      .then(response => {
